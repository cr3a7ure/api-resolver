...
// src/AppBundle/Action/SoftwareApplicationMatchAction.php
...
class SoftwareApplicationMatchAction
{
 ...
 *     path="/api/match",
 *     defaults={"_api_resource_class"=SoftwareApplication::class, "_api_collection_operation_name"="match"}
 * )
 * @Method("PUT")
 */

...
class SoftwareApplicationDeleteAction
{
...
/**
 * @Route(
 *     name="api_graph_delete_action",
 *     path="/software_applications/{id}",
 *     defaults={"_api_resource_class"=SoftwareApplication::class, "_api_item_operation_name"="delete_graph"}
 * )
 * @Method("DELETE")
 */

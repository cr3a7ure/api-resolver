...
// src/AppBundle/Action/ApiUploadAction.php
...
/**
 * @Route(
 *     name="api_upload_action",
 *     path="/api_ref/upload",
 *     defaults={"_api_resource_class"=ApiRef::class, "_api_collection_operation_name"="upload"}
 * )
 * @Method("PUT")
 */
